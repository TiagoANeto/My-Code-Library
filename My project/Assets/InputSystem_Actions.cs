...
public partial class @InputClass: IInputActionCollection2, IDisposable
{
    ...
    ~@InputClass()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputClass.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputClass.UI.Disable() has not been called.");
    }
